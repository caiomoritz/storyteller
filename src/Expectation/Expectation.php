...
class Expectation implements ExpectationInterface
{
    ...
    {
        if (true !== $matcher->match($this->val)) {
            throw new InvalidExpectationException($matcher->errorString($this->val));
        }
    }
    ...
    {
        if (true === $matcher->match($this->val)) {
            throw new InvalidExpectationException($matcher->negationErrorString($this->val));
        }
    }
}
